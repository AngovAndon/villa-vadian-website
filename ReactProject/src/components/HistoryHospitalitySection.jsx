import styles from "./HistoryHospitalitySection.module.css";

function HistoryHospitalitySection() {
  return (
    <div className={styles.fullHH}>
      ...
      <div className={styles.rightHalf}>
        ...
        <div className={styles.bottomPart}>
          ...
          <p className={styles.smallerP}>
            Where time stops, when you want to. Where every experience pays rare
            attention to you.
          </p>
        </div>
      </div>
...
export default HistoryHospitalitySection;
