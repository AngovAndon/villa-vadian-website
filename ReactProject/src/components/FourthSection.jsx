        ...
        <div className={styles.upperHalf}>
          <div className={styles.logoTextMiddle}>
            ...
            <p className={styles.paragraphHH}>
              Indulge in comfort and tranquility at our charming villa, a
              stone's throw from Gevgelija's vibrant energy. With exceptional
              hospitality and modern amenities, it's the perfect escape for
              everyone.
            </p>
          </div>
        </div>
        <div className={styles.lowerHalf}>
          <div className={styles.quotesParagraph}>
            ...
            <p className={styles.smallParagraph}>
              Warning: May cause serious vacation envy!
            </p>
          </div>
        </div>
      </div>
